...
final class Lists {
    ...
    static void format(Locale l, FormatVariable variable, StringBuffer buf, Object... args) {
        ...
        Object formatter = Reflection.invoke(null, ListFormat.getInstance, l, type, ListFormat.FULL);
        Object list = args[variable.index()];
        Reflection.invoke(formatter, ListFormat.format, list, buf, new FieldPosition(0));
    }
    ...
    private static LF init() {
        ...
        Method getInstance = Reflection.meth(ListFormat, "getInstance", Locale.class, ListFormatType, ListFormatStyle);
        Method format = Reflection.meth(ListFormat, "format", Object.class, StringBuffer.class, FieldPosition.class);
        Object STANDARD = Reflection.field(ListFormatType, "STANDARD");
        Object OR = Reflection.field(ListFormatType, "OR");
        Object UNIT = Reflection.field(ListFormatType, "UNIT");
        Object FULL = Reflection.field(ListFormatStyle, "FULL");
